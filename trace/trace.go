...
// bytes is an internal function for constructing the trace based on a threshold
func (t *Trace) bytes(stepThreshold time.Duration) []byte {
	...
	for _, step := range t.steps {
		...
		if stepThreshold == 0 || stepDuration > stepThreshold {
